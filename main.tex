...
definition of \(c(r,k)\) and simplify accordingly.
\begin{multline*}
...
Snadno z Laplaceova rozvoje podle posledního plyne, že determint matice soustavy je nenulový 
\begin{multline*}
  \begin{vmatrix}
    2 & -1 & 0 & \cdots & 0& 0 \\
    0 & 2 & -1 & \cdots & 0& 0 \\
...
$x = (\xi_j) = (\xi_1, \xi_2, \ldots)$ of real or complex numbers for which
\begin{align}
